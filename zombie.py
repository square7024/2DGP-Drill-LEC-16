...
class Zombie:
    ...
    def build_behavior_tree(self):
        ...
        chase_if_boy_near_or_wander = Selector('소년이 가까이 있으면 추적 아니면 배회', chase_boy, wander)
        ...
        root = chase_or_wander = Selector('공에 따라 추적 또는 배회', chase_boy2, wander)
